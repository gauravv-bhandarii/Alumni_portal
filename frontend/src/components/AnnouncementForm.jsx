  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dto = {
        ...
        imageUrl: form.imageUrl || null, // optional
      };
      await api.post("/api/admin/create/announcement", dto);
      setSuccessMsg("Announcement added successfully!");
      setForm({ title: "", shortDescription: "", content: "", imageUrl: "" });
    } catch (err) {
      setErrorMsg(err.response?.data?.message || "Failed to add announcement");
    } finally {
      setLoading(false);
    }
  };
